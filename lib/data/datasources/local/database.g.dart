...
class $CategoriesTable extends Categories
  ...
  static const VerificationMeta _iconColorValueMeta = const VerificationMeta(
    'iconColorValue',
  );
  @override
  ...
  Category map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Category(
      ...
      iconColorValue: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}icon_color_value'],
      )!,
  ...
  Category copyWithCompanion(CategoriesCompanion data) {
    return Category(
      ...
      iconCodePoint: data.iconCodePoint.present
          ...
          : this.iconCodePoint,
      iconColorValue: data.iconColorValue.present
          ? data.iconColorValue.value
          : this.iconColorValue,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, amount, transactionDate, note, categoryId, type);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$CategoriesTableFilterComposer
  ...
  ColumnFilters<int> get iconColorValue => $composableBuilder(
    column: $table.iconColorValue,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CategoriesTableOrderingComposer
  ...
  ColumnOrderings<int> get iconColorValue => $composableBuilder(
    column: $table.iconColorValue,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CategoriesTableAnnotationComposer
  ...
  GeneratedColumn<int> get iconColorValue => $composableBuilder(
    column: $table.iconColorValue,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> iconColorValue = const Value.absent(),
